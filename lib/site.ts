export const site = {
  ...
  title:
    "Devesh Kumar Singh | React Native, AI, ESG & Sustainability Engineer",
  description:
    "Devesh Kumar Singh is a React Native and full-stack mobile engineer writing about React Native, AI, backend systems, ESG, sustainability, and contextual intelligence. Currently building at GreensTurn.",
